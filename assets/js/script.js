$(function () {
  ...
  var importShape = require('./shape')
    console.log(importShape)
    importShape.moveTo(100, 150)


  // Main Shape Pikachu & Proto
  var importPikachu = require('./pikachu')
    importPikachu.moveRight()
    importPikachu.moveLeft()


  // Main Shape Ball & Proto
  var importBall = require('./ball')
    importBall.arcTo()
    importBall.move()
    importBall.hitBottom()
