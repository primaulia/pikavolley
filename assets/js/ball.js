...
function Ball (positionX, positionY, color, canvasWidth, canvasHeight, gutter) {
  Shape.call(this, positionX, positionY, color, canvasWidth, canvasHeight, gutter)
  this.radius = 20
  this.startAngle = 0
  this.endAngle = 360
  this.speed = 100
...
// var ball = new Ball(0, 400, 'red', 500, 600, 360)
// console.log(ball)
// ball.moveTo(8,9)
// console.log(ball)
// ball.move(75)
